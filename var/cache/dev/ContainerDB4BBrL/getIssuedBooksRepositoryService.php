 ...
 */
class getIssuedBooksRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IssuedBooksRepository' shared autowired service.
     *
     * @return \App\Repository\IssuedBooksRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IssuedBooksRepository.php';

        return $container->privates['App\\Repository\\IssuedBooksRepository'] = new \App\Repository\IssuedBooksRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
